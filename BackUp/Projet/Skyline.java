...
public class Skyline {
	...
	private static Volume[] Objet_Placé = new Volume[4];
	...
	public static void main(String[] args) {
		...
		Objet_Placé[3]=V4;
		Objet_Placé[4]=V5;
		Skyline = Trouver_SkyLine(Objet_Placé, Conteneur);
		int i = 0;
	...
	public static ArrayList<Point> Trouver_SkyLine(Volume[] Objet_Placé, Volume Conteneur ) {
		  //Point[] Skyline;
		  int i = 0 ;
		  Point tmp = null;
		  tmp.setX(0);
